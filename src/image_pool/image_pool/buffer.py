...
class ImageRingBuffer:
    def __init__(self, maxlen: int = 30, sync_tolerance_ms: float = 80.0):
        ...
        self.default_save_dir = "/home/yipeng/image_bridge_saved"
        os.makedirs(self.default_save_dir, exist_ok=True)
        self.save_rgb_ext = ".jpg"
    ...
    def get_ringbuffer_instance(self) -> ImageRingBuffer:
        return self.instance
    
    def save_latest(self, out_dir: Optional[str] = None) -> Dict[str, Any]:
        out_dir = out_dir or self.default_save_dir
        ...
        with self._lock:
            ...
            rgb_path = prefix + "_rgb" + self.save_rgb_ext
